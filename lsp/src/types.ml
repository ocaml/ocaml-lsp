          ...
          | (field_name, _field_yojson) :: tail ->
            ...
            | "signatureInformation" -> (
              ...
              | None ->
                let fvalue =
                  Json.Nullable_option.t_of_yojson
                    signatureInformation_of_yojson _field_yojson
                in
          ...
          | (field_name, _field_yojson) :: tail ->
            ...
            | "documentHighlight" -> (
              ...
              | None ->
                let fvalue =
                  Json.Nullable_option.t_of_yojson
                    DocumentHighlightClientCapabilities.t_of_yojson
                    _field_yojson
                in
        ...
        let rec iter = function
          | (field_name, _field_yojson) :: tail ->
            ...
            | "window" -> (
              ...
              | None ->
                let fvalue =
                  Json.Nullable_option.t_of_yojson window_of_yojson
                    _field_yojson
                in
      ...
      | { title = v_title
        ...
        let bnds =
          if None = v_edit then
            ...
            let arg =
              (Json.Nullable_option.yojson_of_t WorkspaceEdit.yojson_of_t)
                v_edit
            in
            let bnd = ("edit", arg) in
            bnd :: bnds
      ...
      | { id = v_id } ->
        ...
        let bnds =
          if None = v_id then
            ...
            let arg =
              (Json.Nullable_option.yojson_of_t yojson_of_string) v_id
            in
            let bnd = ("id", arg) in
            bnd :: bnds
        in
          ...
          | (field_name, _field_yojson) :: tail ->
            ...
            | "foldingRangeProvider" -> (
              ...
              | None ->
                let fvalue =
                  Json.Nullable_option.t_of_yojson
                    foldingRangeProvider_of_yojson _field_yojson
                in
      ...
      | { textDocumentSync = v_textDocumentSync
        ...
        let bnds =
          if None = v_selectionRangeProvider then
            ...
            let arg =
              (Json.Nullable_option.yojson_of_t
                 yojson_of_selectionRangeProvider)
        ...
        let bnds =
          if None = v_executeCommandProvider then
            ...
            let arg =
              (Json.Nullable_option.yojson_of_t
                 ExecuteCommandOptions.yojson_of_t)
        ...
        let bnds =
          if None = v_documentSymbolProvider then
            ...
            let arg =
              (Json.Nullable_option.yojson_of_t
                 yojson_of_documentSymbolProvider)
        ...
        let bnds =
          if None = v_implementationProvider then
            ...
            let arg =
              (Json.Nullable_option.yojson_of_t
                 yojson_of_implementationProvider)
        ...
        let bnds =
          if None = v_typeDefinitionProvider then
            ...
            let arg =
              (Json.Nullable_option.yojson_of_t
                 yojson_of_typeDefinitionProvider)
        ...
        let bnds =
          if None = v_signatureHelpProvider then
            ...
            let arg =
              (Json.Nullable_option.yojson_of_t
                 SignatureHelpOptions.yojson_of_t)
      ...
      | { textDocument = v_textDocument
        ...
        let bnds =
          if None = v_context then
            ...
            let arg =
              (Json.Nullable_option.yojson_of_t
                 SignatureHelpContext.yojson_of_t)
                v_context
            in
            let bnd = ("context", arg) in
            bnd :: bnds

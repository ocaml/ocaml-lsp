...
and didChangeTextDocumentParams_of_yojson =
  (let _tp_loc = "lsp/src/protocol.ml.DidChange.didChangeTextDocumentParams" in
   function
   | `Assoc field_yojsons as yojson ->
       let textDocument_field = ref None
...
and textDocumentContentChangeEvent_of_yojson =
  (let _tp_loc =
     "lsp/src/protocol.ml.DidChange.textDocumentContentChangeEvent" in
   function
   | `Assoc field_yojsons as yojson ->
...
and publishDiagnosticsParams_of_yojson =
  (let _tp_loc =
     "lsp/src/protocol.ml.PublishDiagnostics.publishDiagnosticsParams" in
   function
   | `Assoc field_yojsons as yojson ->
       let uri_field = ref None
...
and diagnosticRelatedInformation_of_yojson =
  (let _tp_loc =
     "lsp/src/protocol.ml.PublishDiagnostics.diagnosticRelatedInformation" in
   function
   | `Assoc field_yojsons as yojson ->
...
let textDocumentClientCapabilities_of_yojson =
  (let _tp_loc =
     "lsp/src/protocol.ml.Initialize.textDocumentClientCapabilities" in
   function
   | `Assoc field_yojsons as yojson ->
...
let workspaceClientCapabilities_of_yojson =
  (let _tp_loc = "lsp/src/protocol.ml.Initialize.workspaceClientCapabilities" in
   function
   | `Assoc field_yojsons as yojson ->
...
let telemetryClientCapabilities_of_yojson =
  (let _tp_loc = "lsp/src/protocol.ml.Initialize.telemetryClientCapabilities" in
   function
   | `Assoc field_yojsons as yojson ->
...
and documentOnTypeFormattingOptions_of_yojson =
  (let _tp_loc =
     "lsp/src/protocol.ml.Initialize.documentOnTypeFormattingOptions" in
   function
   | `Assoc field_yojsons as yojson ->
